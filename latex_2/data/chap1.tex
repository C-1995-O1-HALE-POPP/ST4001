...
\begin{table}[ht]
    \centering
    \caption{Comparison of medical benchmarks for clinical AI. \textit{Legend:} EHR = real electronic health record data. Agent = interactive agent-based evaluation. Memory Study = systematic memory architecture ablation.}
    \label{tab:med_bench}
