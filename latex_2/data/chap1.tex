...
\paragraph{Retrieval-Augmented Generation (RAG)} The foundational RAG paradigm \cite{lewis2020rag} augments LLM inference by retrieving relevant documents from an external knowledge base and prepending them to the context window, enabling scale beyond the context window at the cost of retrieval quality.
